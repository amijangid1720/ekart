...
calculatedDiscount(product: { id: number; name: string; description: string; brand: string; gender: string; category: string; size: number[]; color: (string|undefined)[]; price: number; discountPrice: number; is_in_inventory: boolean; items_left: number; imageURL: string; slug: string; }) {
return(((product.price-product.discountPrice)/product.price)*100).toFixed(0);
  ...
  products = [
    ...
    },
    {
      ...
      items_left: 4,
      imageURL:
        'https://images.unsplash.com/photo-1543508282-6319a3e2621f?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTR8fG1lbiUyMGZvcm1hbCUyMHNob2VzfGVufDB8fDB8fHww',
    ...
    },
    {
      ...
      items_left: 2,
      imageURL:
        'https://images.unsplash.com/photo-1560769629-975ec94e6a86?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8bWVuJTIwZm9ybWFsJTIwc2hvZXN8ZW58MHx8MHx8fDA%3D',
      slug: 'austin',
    },
    {
      id: 20,
    ...
    },
    {
      ...
      items_left: 3,
      imageURL:
        'https://plus.unsplash.com/premium_photo-1676234844384-82e1830af724?q=80&w=1888&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      slug: 'ss-pm-0093',
    },
    {
      id: 26,
  ...
  totalOutStock:number=this.products.filter(p=> p.is_in_inventory===false).length;
  selectedFilter:string='all';
  @Input()
  closeButton:ProductDetailComponent;
